...
/*
 * 触摸屏校准参数（固化值，免去每次开机手动校准）
 *
 * 获取方式：保留原 5 点校准代码，跑通后记录以下 4 个值填入即可。
 *   - fac.x / fac.y   → 每 LCD 像素对应的 ADC 计数
 *   - center.x / center.y → 屏幕中心点 (LCD_W/2, LCD_H/2) 对应的 ADC 值
 *
 * 以下为占位值，请根据实测替换！
 */
#define ATK_MD0280_TOUCH_FAC_X      13.5f  /* TODO: 替换为实测 fac.x */
#define ATK_MD0280_TOUCH_FAC_Y      10.5f  /* TODO: 替换为实测 fac.y */
#define ATK_MD0280_TOUCH_CENTER_X   2212     /* TODO: 替换为实测 center.x */
#define ATK_MD0280_TOUCH_CENTER_Y   2150     /* TODO: 替换为实测 center.y */
