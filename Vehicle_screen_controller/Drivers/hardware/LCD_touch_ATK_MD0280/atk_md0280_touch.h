...
/* 引脚定义 */
#define ATK_MD0280_TOUCH_PEN_GPIO_PORT          GPIOF
#define ATK_MD0280_TOUCH_PEN_GPIO_PIN           GPIO_PIN_10
#define ATK_MD0280_TOUCH_PEN_GPIO_CLK_ENABLE()  do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)
