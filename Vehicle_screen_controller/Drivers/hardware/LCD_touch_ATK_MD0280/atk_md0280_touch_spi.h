...
#define ATK_MD0280_TOUCH_SPI_MO_GPIO_PIN            GPIO_PIN_9
#define ATK_MD0280_TOUCH_SPI_MO_GPIO_CLK_ENABLE()   do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)
#define ATK_MD0280_TOUCH_SPI_TCS_GPIO_PORT          GPIOF
#define ATK_MD0280_TOUCH_SPI_TCS_GPIO_PIN           GPIO_PIN_11
#define ATK_MD0280_TOUCH_SPI_TCS_GPIO_CLK_ENABLE()  do{ __HAL_RCC_GPIOF_CLK_ENABLE(); }while(0)
#define ATK_MD0280_TOUCH_SPI_CLK_GPIO_PORT          GPIOB
#define ATK_MD0280_TOUCH_SPI_CLK_GPIO_PIN           GPIO_PIN_1
