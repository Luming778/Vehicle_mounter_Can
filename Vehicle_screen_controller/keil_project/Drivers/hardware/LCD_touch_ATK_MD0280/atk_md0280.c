...
static inline uint16_t atk_md0280_get_chip_id(void)
{
    ...
    {
        /* 尝试获取ID2 */
        atk_md0280_fsmc_write_cmd(0x04);
        chip_id = atk_md0280_fsmc_read_dat();
        chip_id = atk_md0280_fsmc_read_dat();
        chip_id = atk_md0280_fsmc_read_dat() << 8;
        chip_id |= (atk_md0280_fsmc_read_dat()) & 0x00FF;
...
static void atk_md0280_reg_init(void)
{
    ...
    {
        atk_md0280_fsmc_write_cmd(0xCF);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0xC1);
        atk_md0280_fsmc_write_dat(0x30);
        atk_md0280_fsmc_write_cmd(0xED);
        atk_md0280_fsmc_write_dat(0x64);
        atk_md0280_fsmc_write_dat(0x03);
        atk_md0280_fsmc_write_dat(0x12);
        atk_md0280_fsmc_write_dat(0x81);
        atk_md0280_fsmc_write_cmd(0xE8);
        atk_md0280_fsmc_write_dat(0x85);
        atk_md0280_fsmc_write_dat(0x10);
        atk_md0280_fsmc_write_dat(0x7A);
        atk_md0280_fsmc_write_cmd(0xCB);
        atk_md0280_fsmc_write_dat(0x39);
        atk_md0280_fsmc_write_dat(0x2C);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x34);
        atk_md0280_fsmc_write_dat(0x02);
        atk_md0280_fsmc_write_cmd(0xF7);
        atk_md0280_fsmc_write_dat(0x20);
        atk_md0280_fsmc_write_cmd(0xEA);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_cmd(0xC0);
        atk_md0280_fsmc_write_dat(0x1B);
        atk_md0280_fsmc_write_cmd(0xC1);
        atk_md0280_fsmc_write_dat(0x01);
        atk_md0280_fsmc_write_cmd(0xC5);
        atk_md0280_fsmc_write_dat(0x30);
        atk_md0280_fsmc_write_dat(0x30);
        atk_md0280_fsmc_write_cmd(0xC7);
        atk_md0280_fsmc_write_dat(0xB7);
        atk_md0280_fsmc_write_cmd(0x36);
        atk_md0280_fsmc_write_dat(0x48);
        atk_md0280_fsmc_write_cmd(0x3A);
        atk_md0280_fsmc_write_dat(0x55);
        atk_md0280_fsmc_write_cmd(0xB1);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x1A);
        atk_md0280_fsmc_write_cmd(0xB6);
        atk_md0280_fsmc_write_dat(0x0A);
        atk_md0280_fsmc_write_dat(0xA2);
        atk_md0280_fsmc_write_cmd(0xF2);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_cmd(0x26);
        atk_md0280_fsmc_write_dat(0x01);
        atk_md0280_fsmc_write_cmd(0xE0);
        atk_md0280_fsmc_write_dat(0x0F);
        atk_md0280_fsmc_write_dat(0x2A);
        atk_md0280_fsmc_write_dat(0x28);
        atk_md0280_fsmc_write_dat(0x08);
        atk_md0280_fsmc_write_dat(0x0E);
        atk_md0280_fsmc_write_dat(0x08);
        atk_md0280_fsmc_write_dat(0x54);
        atk_md0280_fsmc_write_dat(0xA9);
        atk_md0280_fsmc_write_dat(0x43);
        atk_md0280_fsmc_write_dat(0x0A);
        atk_md0280_fsmc_write_dat(0x0F);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_cmd(0xE1);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x15);
        atk_md0280_fsmc_write_dat(0x17);
        atk_md0280_fsmc_write_dat(0x07);
        atk_md0280_fsmc_write_dat(0x11);
        atk_md0280_fsmc_write_dat(0x06);
        atk_md0280_fsmc_write_dat(0x2B);
        atk_md0280_fsmc_write_dat(0x56);
        atk_md0280_fsmc_write_dat(0x3C);
        atk_md0280_fsmc_write_dat(0x05);
        atk_md0280_fsmc_write_dat(0x10);
        atk_md0280_fsmc_write_dat(0x0F);
        atk_md0280_fsmc_write_dat(0x3F);
        atk_md0280_fsmc_write_dat(0x3F);
        atk_md0280_fsmc_write_dat(0x0F);
        ...
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0xEF);
        atk_md0280_fsmc_write_cmd(0x11);
        HAL_Delay(100);
        atk_md0280_fsmc_write_cmd(0x29);
    }
    else if (g_atk_md0280_sta.chip_id == ATK_MD0280_CHIP_ID2)
    {
        ...
        atk_md0280_fsmc_write_cmd(0x3A);
        atk_md0280_fsmc_write_dat(0x05);
        atk_md0280_fsmc_write_cmd(0xB2);
        atk_md0280_fsmc_write_dat(0x0C);
        atk_md0280_fsmc_write_dat(0x0C);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x33);
        atk_md0280_fsmc_write_dat(0x33);
        atk_md0280_fsmc_write_cmd(0xB7);
        atk_md0280_fsmc_write_dat(0x35);
        atk_md0280_fsmc_write_cmd(0xBB);
        atk_md0280_fsmc_write_dat(0x32);
        atk_md0280_fsmc_write_cmd(0xC0);
        atk_md0280_fsmc_write_dat(0x0C);
        atk_md0280_fsmc_write_cmd(0xC2);
        atk_md0280_fsmc_write_dat(0x01);
        atk_md0280_fsmc_write_cmd(0xC3);
        atk_md0280_fsmc_write_dat(0x10);
        atk_md0280_fsmc_write_cmd(0xC4);
        atk_md0280_fsmc_write_dat(0x20);
        atk_md0280_fsmc_write_cmd(0xC6);
        atk_md0280_fsmc_write_dat(0x0F);
        atk_md0280_fsmc_write_cmd(0xD0);
        atk_md0280_fsmc_write_dat(0xA4);
        atk_md0280_fsmc_write_dat(0xA1);
        atk_md0280_fsmc_write_cmd(0xE0);
        atk_md0280_fsmc_write_dat(0xD0);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x02);
        atk_md0280_fsmc_write_dat(0x07);
        atk_md0280_fsmc_write_dat(0x0A);
        atk_md0280_fsmc_write_dat(0x28);
        atk_md0280_fsmc_write_dat(0x32);
        atk_md0280_fsmc_write_dat(0x44);
        atk_md0280_fsmc_write_dat(0x42);
        atk_md0280_fsmc_write_dat(0x06);
        atk_md0280_fsmc_write_dat(0x0E);
        atk_md0280_fsmc_write_dat(0x12);
        atk_md0280_fsmc_write_dat(0x14);
        atk_md0280_fsmc_write_dat(0x17);
        atk_md0280_fsmc_write_cmd(0xE1);
        atk_md0280_fsmc_write_dat(0xD0);
        atk_md0280_fsmc_write_dat(0x00);
        ...
        atk_md0280_fsmc_write_dat(0x0A);
        atk_md0280_fsmc_write_dat(0x28);
        atk_md0280_fsmc_write_dat(0x31);
        atk_md0280_fsmc_write_dat(0x54);
        atk_md0280_fsmc_write_dat(0x47);
        atk_md0280_fsmc_write_dat(0x0E);
        atk_md0280_fsmc_write_dat(0x1C);
        atk_md0280_fsmc_write_dat(0x17);
        atk_md0280_fsmc_write_dat(0x1B);
        atk_md0280_fsmc_write_dat(0x1E);
        atk_md0280_fsmc_write_cmd(0x2A);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x00);
        atk_md0280_fsmc_write_dat(0x00);
...
{
    atk_md0280_fsmc_write_cmd(0x2A);
    atk_md0280_fsmc_write_dat((uint8_t)(sc >> 8) & 0xFF);
    atk_md0280_fsmc_write_dat((uint8_t)sc & 0xFF);
    atk_md0280_fsmc_write_dat((uint8_t)(ec >> 8) & 0xFF);
    atk_md0280_fsmc_write_dat((uint8_t)ec & 0xFF);
}
...
{
    atk_md0280_fsmc_write_cmd(0x2B);
    atk_md0280_fsmc_write_dat((uint8_t)(sp >> 8) & 0xFF);
    atk_md0280_fsmc_write_dat((uint8_t)sp & 0xFF);
    atk_md0280_fsmc_write_dat((uint8_t)(ep >> 8) & 0xFF);
    atk_md0280_fsmc_write_dat((uint8_t)ep & 0xFF);
}
...
{
    atk_md0280_fsmc_write_cmd(0x2E);
}
...
{
    atk_md0280_fsmc_write_cmd(0x28);
}
